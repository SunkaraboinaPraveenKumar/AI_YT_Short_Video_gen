...
function Topic({ onHandleInputChange, title }) {
    ...
    const GenerateScript = async () => {
        ...
        try {
            // Use the current title from props which is controlled by the parent
    ...
    return (
        <div>
            ...
            {/* Bind the input value to the parent's title prop */}
            <Input 
                        ...
                        <div className='grid grid-cols-2 gap-5 mt-1'>
                            {scripts.map((item, index) => (
                                <div
                                    ...
                                    className={`p-3 border rounded-lg mt-3 cursor-pointer ${selectedScriptIndex === index && 'bg-secondary border-white'}`}
                                >
            ...
            <Button className='mt-3' size="sm" onClick={GenerateScript} disabled={loading}>
